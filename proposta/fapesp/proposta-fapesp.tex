...
Para refletir isso, podemos colocar um peso \(w_i\) \todo{conflita com o w acima} em cada vértice e restringir a soma dos pesos dos vértices alocados a cada uma das cores, uma restrição de capacidade.
...
\todo[inline]{talvez uns resultados masi atualizados?}
...
Proposto por \textcite{Mehrotra1996ColumnGenerationApproach}, outra forma de entender o problema é imaginá-lo como um \textbf{problema de cobertura de conjuntos} (do inglês, SC) onde os conjuntos disponíveis são os conjuntos independentes dos vértices.\todo{conjunto conjunto conjunto}
...
Por tal motivo, \textcite{Mehrotra1996ColumnGenerationApproach} propuseram um algoritmo de \emph{branch-and-price} \todo{definir} baseado nesta modelagem.
