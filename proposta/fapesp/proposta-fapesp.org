...
Nesse projeto, almejamos a última e aplicar algoritmos de /Branch-and-Price/ para superar os resultados da literatura.
Acreditamos que nosso trabalho se diferencia ao aplicar técnicas propostas por [cite/text:@Lima2022Exactsolutionnetwork] e [cite/text:@Pessoa2021SolvingBinPacking].
...
Além deste, é importante mencionar os métodos de ponto interno [cite:@Karmarkar1984newpolynomialtime] e o elipsóide [cite:@Bland1981FeatureArticleTheEllipsoid] como alternativas ao simplex.
...
b. A relaxação linear do modelo (quando a restrição de integridade é removida) é extremamente fraca. Assim, resolvê-la ainda nos deixa muito distante da solução ótima inteira, o que não é muito útil.

Afim de resolver tais problemas, [cite/text:@MendezDiaz2006BranchCutAlgorithm] adicionaram a restrição
...
Apresentado inicialmente por [cite/text:@Jabrayilov2018NewIntegerLinear] e posteriormente melhorado [cite:@Jabrayilov2022StrengthenedPartialOrdering], utilizamos um misto do modelo de atribuição e a ordenação parcial.
