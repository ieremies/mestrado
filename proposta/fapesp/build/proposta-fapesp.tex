...
\caption{\label{fig:diagrama_decisao}Imagem retirada de \autocite{Hoeve2021Graphcoloringdecision}. Ao lado esquerdo, um grafo, e ao lado direito, um correspondente diagrama de decisão.}
\end{figure}
